...
Контроллер рулонных штор на ESP32-WROOM-32 с интеграцией в умный дом через Matter (Алиса, Home Assistant, Apple Home, Google Home).
...
Питание 5В подаётся через стабилизатор **ASM1117-3.3**, который даёт 3.3В для ESP32.
