...
Разьем Type-C на макетной плате - 1шт (продается как Type-C на кабель с разъемом, если собираете на ESP32-WROOM-32)   
...
Понадобится программатор ESP32 (стоит копейки, обычный VCP по сути) если собираете на ESP32-WROOM-32   
На отладочной плате все уже интегрировано.   
...
Корпус устройства и все пластиковые детали напечатаны платиком PETG на 3D принтере.
Все 3D подели в формате STL лежат в папке STL.   
В шторах надо заменить механизм подъема на напечатанный механизм с мотором.
